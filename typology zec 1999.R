...
##### The following code identifies pathological mappings in the output grammrs and classifies the grammars based on their pathological profiles
...
############## Pathological Tonal  Flop: High tone shifts away from the head mora of a bimoraic trochee, contrary to the observed preference for High-toned foot heads (de Lacy 2002)
